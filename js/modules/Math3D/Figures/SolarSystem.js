class SolarSystem{
    constructor() {
        ...
        this.figures[1].center = new Point(0.4 * this.NRAE, 0, 0);
        ...
        this.figures[2].center = new Point(0.7 * this.NRAE, 0, 0);
        ...
        this.figures[3].center = new Point(this.NRAE, 0, 0);
        ...
        this.figures[4].center = new Point(1.5 * this.NRAE, 0, 0);
        ...
        this.figures[5].center = new Point(5.2 * this.NRAE, 0, 0);
        ...
        this.figures[6].center = new Point(9.5 * this.NRAE, 0, 0);
        this.figures[6].animations = [{
            method: 'rotateY',
            value: [0.43 / 365, 29.4]
        }];
        this.figures[7] = new Tor(127.5, 42.5, 2, 20, 20, '#9adeb3');
        this.figures[7].center = new Point(9.5 * this.NRAE, 0, 0);
        ...
        this.figures[8].center = new Point(19 * this.NRAE, 0, 0);
        ...
        this.figures[9].center = new Point(30.1 * this.NRAE, 0, 0);
