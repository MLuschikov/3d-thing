Template.prototype.Graph3DUITemplate = () => `
<div id="figureChecklist">
    <button class="figurePlus" data-figure="Cube">Box +</button>
    <button class="figurePlus" data-figure="Sphere">Sphere +</button>
