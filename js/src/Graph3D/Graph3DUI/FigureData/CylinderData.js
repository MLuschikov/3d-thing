class CylinderData {
    constructor(num) {
        ...
        this.isCup = document.createElement('input');
        this.isCup.type = 'checkbox';
        this.isCup.dataset.num = num;
        this.isCup.id = 'isCup';
        this.isCup.className = 'size';
        this.isCup.checked = true;
        ...
        this.td34.innerHTML = 'Cup?';
        this.td34.appendChild(this.isCup);
